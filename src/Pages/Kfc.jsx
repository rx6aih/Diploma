...
const Kfc = () => {
    const [bestCupones, setBestCupones] = useState([
        {image: "https://s82079.cdn.ngenix.net/230x230/ikcsm0oiyelxtrng2lu2k7jxfkst.png", text:"5050", buttonText:"Перейти"},
        {image: "https://s82079.cdn.ngenix.net/230x230/ikcsm0oiyelxtrng2lu2k7jxfkst.png", text:"5050", buttonText:"Перейти"},
        {image: "https://s82079.cdn.ngenix.net/230x230/ikcsm0oiyelxtrng2lu2k7jxfkst.png", text:"5050", buttonText:"Перейти"}
    ])
    ...
    return (
        <div className={"flex items-center flex-col mt-16"}>
            <div className={"flex flex-col justify-center w-[80%]"}>
                <div className={"flex flex-col mb-20 pb-4 w-fit rounded-3xl p-2 bg-[#ffb03d]"}>
                    <p className={"text-white text-[40px] font-extrabold"}>ЛУЧШИЕ КУПОНЫ</p>
                    <div className={"flex gap-4"}>
                        {
                            bestCupones.map((item,index) =>
                                <div className={"w-[200px]"}>
                                    <BlurCard img={item.image} text={item.text} buttonText={item.buttonText} textColor={"black"} width={200} height={200}/>
                                </div>
                            )
                        }
                    </div>
